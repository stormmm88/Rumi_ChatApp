  ...
  const handleSubmit = async (e: React.FormEvent) => {
    try {
      ...
      if (invitedUsers.length === 0) {
        toast.warning('Bạn cần thêm ít nhất 1 thành viên')
        return
      }
      ...
      console.error('Lỗi khi gọi handleSubmit trong NewGroupChatModal:', error)
    }
  }
    ...
    <Dialog>
      <DialogTrigger asChild>
        <Button
          ...
          className="flex z-10 items-center justify-center size-5 rounded-full
