...
//zodResolver giúp kết nối zod với react-hook-form

// định nghĩa zodSchema, phần mô tả điều kiện của form đăng kí
          ...
          <form className="p-6 md:p-8" onSubmit={handleSubmit(onSubmit)}>
            <div className="flex flex-col gap-6">
              ...
              <div className="flex flex-col item-center text-center gap-2">
                ...
                <h1 className="text-2xl font-bold">Tạo tài khoản Rumi</h1>
